(ns marketentry.registry
  ...
  call to any real procurement portal (SOCE). It builds the RECORD an
...
(defn register-draft
  ...
  market-entry operator's own act of preparing a SOCE registration
...
(defn register-submit
  ...
  market-entry operator's own act of actually submitting a SOCE
