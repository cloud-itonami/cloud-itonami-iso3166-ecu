(ns marketentry.store
  "SSoT for the ECU market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Quito Digital S.A." :portal "SOCE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-legal-rep-change? true :legal-rep-change-approved? true
             :requires-ruc? true :ruc-verified? true
             :drafted? false :submitted? false
             :jurisdiction "ECU" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "SOCE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-legal-rep-change? true :legal-rep-change-approved? true
             :requires-ruc? true :ruc-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Guayaquil Ventures Cia. Ltda." :portal "SOCE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "ECU" :status :intake}
    "eng-4" {:id "eng-4" :operator "Andes Export S.A." :portal "SOCE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-legal-rep-change? true :legal-rep-change-approved? false
             :requires-ruc? true :ruc-verified? true
             :drafted? false :submitted? false
             :jurisdiction "ECU" :status :intake}
    "eng-5" {:id "eng-5" :operator "Cuenca Logistics" :portal "SOCE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-legal-rep-change? true :legal-rep-change-approved? true
             :requires-ruc? true :ruc-verified? false
             :drafted? false :submitted? false
             :jurisdiction "ECU" :status :intake}
    "eng-6" {:id "eng-6" :operator "Sierra Civic Tech" :portal "SOCE"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-legal-rep-change? legal-rep-change-approved?
                               requires-ruc? ruc-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-legal-rep-change?)    (assoc :engagement/requires-legal-rep-change? requires-legal-rep-change?)
    (some? legal-rep-change-approved?)    (assoc :engagement/legal-rep-change-approved? legal-rep-change-approved?)
    (some? requires-ruc?)                 (assoc :engagement/requires-ruc? requires-ruc?)
    (some? ruc-verified?)                 (assoc :engagement/ruc-verified? ruc-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-legal-rep-change? :engagement/legal-rep-change-approved?
   :engagement/requires-ruc? :engagement/ruc-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-legal-rep-change? (boolean (:engagement/requires-legal-rep-change? m))
     :legal-rep-change-approved? (boolean (:engagement/legal-rep-change-approved? m))
     :requires-ruc? (boolean (:engagement/requires-ruc? m))
     :ruc-verified? (boolean (:engagement/ruc-verified? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-ecu"})
